...
const Manage: React.FC = () => {
  ...
  const handleEdit = (id: number) => { // Type 'id' as number
  ...
  const handleDelete = (id: number) => { // Type 'id' as number
  ...
  return (
    <div className="min-h-screen p-5 bg-white text-black font-sans">
      ...
      {/* Listings */}
      <div>
        {listings.map((listing: Listing) => ( // Explicitly type 'listing'
          <div key={listing.id} className="bg-white  p-4 mb-4 flex items-start ">
