  ...
  return (
    <div className="min-h-screen p-5 bg-white text-black font-sans">
      ...
      <div className="flex items-center mb-8">
        ...
        <h1 className="text-2xl font-bold text-center ml-6">Manage listing</h1>
      </div>
      ...
      <div>
        {listings.map((listing) => (
          <div key={listing.id} className="bg-[#331a5f] rounded-xl p-4 mb-4 flex items-center shadow-lg">
